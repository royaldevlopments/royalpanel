...
use RoyalPanel\Transformers\Api\Client\TaskTransformer;
use RoyalPanel\Http\Requests\Api\Client\ClientApiRequest;
use RoyalPanel\Http\Controllers\Api\Client\ClientApiController;
use RoyalPanel\Exceptions\Service\ServiceLimitExceededException;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use RoyalPanel\Http\Requests\Api\Client\Servers\Schedules\StoreTaskRequest;
...
class ScheduleTaskController extends ClientApiController
{
    ...
    {
        $limit = config('royalpanel.client_features.schedules.per_schedule_task_limit', 10);
