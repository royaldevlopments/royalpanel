...
use RoyalPanel\Transformers\Api\Client\ScheduleTransformer;
use RoyalPanel\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use RoyalPanel\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use RoyalPanel\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use RoyalPanel\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use RoyalPanel\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use RoyalPanel\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    public function update(UpdateScheduleRequest $request, Server $server, Schedule $schedule): array
    {
        ...
        //
        // @see https://github.com/royalpanel/panel/issues/2425
