...
class RoyalAdvancedController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return $this->view->make('admin.royal.advanced', [
            ...
            'oauthDiscordClientId' => $this->settings->get('settings::royal:oauth_discord_client_id', ''),
            'oauthDiscordClientSecret' => $this->settings->get('settings::royal:oauth_discord_client_secret', ''),
            'oauthGithubEnabled' => $this->settings->get('settings::royal:oauth_github_enabled', false),
            'oauthGithubClientId' => $this->settings->get('settings::royal:oauth_github_client_id', ''),
            'oauthGithubClientSecret' => $this->settings->get('settings::royal:oauth_github_client_secret', ''),
            'oauthGoogleEnabled' => $this->settings->get('settings::royal:oauth_google_enabled', false),
            'oauthGoogleClientId' => $this->settings->get('settings::royal:oauth_google_client_id', ''),
            'oauthGoogleClientSecret' => $this->settings->get('settings::royal:oauth_google_client_secret', ''),
