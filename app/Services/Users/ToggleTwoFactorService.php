...
use RoyalPanel\Repositories\Eloquent\RecoveryTokenRepository;
use RoyalPanel\Exceptions\Service\User\TwoFactorAuthenticationTokenInvalid;
...
class ToggleTwoFactorService
{
    ...
    public function handle(User $user, string $token, ?bool $toggleState = null): array
    {
        ...
        $isValidToken = $this->google2FA->verifyKey($secret, $token, config()->get('royalpanel.auth.2fa.window'));
