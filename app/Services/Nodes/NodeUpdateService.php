...
namespace RoyalPanel\Services\Nodes;
...
use RoyalPanel\Repositories\Wings\DaemonConfigurationRepository;
use RoyalPanel\Exceptions\Http\Connection\DaemonConnectionException;
use RoyalPanel\Exceptions\Service\Node\ConfigurationNotPersistedException;
    ...
    public function handle(Node $node, array $data, bool $resetToken = false): Node
    {
        ...
        [$updated, $exception] = $this->connection->transaction(function () use ($data, $node) {
            ...
            try {
                ...
                //
                // @see https://github.com/royalpanel/panel/issues/1931
                ...
                //
                // @see https://github.com/royalpanel/panel/issues/2712
                return [$updated, true];
            }
