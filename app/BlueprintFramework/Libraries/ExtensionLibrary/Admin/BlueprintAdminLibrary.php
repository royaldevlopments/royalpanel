...
namespace RoyalPanel\BlueprintFramework\Libraries\ExtensionLibrary\Admin;

use RoyalPanel\BlueprintFramework\Libraries\ExtensionLibrary\BlueprintBaseLibrary;
...
class BlueprintAdminLibrary extends BlueprintBaseLibrary
{
  ...
  /**
   * (Deprecated) Display a notification on the RoyalPanel admin panel (on next page load).
  ...
  /**
   * (Deprecated) Display a notification on the RoyalPanel admin panel and refresh the page after a certain delay.
  ...
  /**
   * (Deprecated) Display a notification on the RoyalPanel admin panel and refresh the page instantly.
