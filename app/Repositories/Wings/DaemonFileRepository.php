...
use RoyalPanel\Exceptions\Http\Server\FileSizeTooLargeException;
use RoyalPanel\Exceptions\Http\Connection\DaemonConnectionException;

/**
 * @method \RoyalPanel\Repositories\Wings\DaemonFileRepository setNode(\RoyalPanel\Models\Node $node)
 * @method \RoyalPanel\Repositories\Wings\DaemonFileRepository setServer(\RoyalPanel\Models\Server $server)
 */
