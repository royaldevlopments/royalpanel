...
use RoyalPanel\Exceptions\Http\Server\ServerStateConflictException;

/**
 * \RoyalPanel\Models\Server.
 *
 * @property int $id
 ...
 * @property \Illuminate\Database\Eloquent\Collection|\RoyalPanel\Models\ActivityLog[] $activity
 * @property int|null $activity_count
 * @property Allocation|null $allocation
 * @property \Illuminate\Database\Eloquent\Collection|\RoyalPanel\Models\Allocation[] $allocations
 * @property int|null $allocations_count
 * @property \Illuminate\Database\Eloquent\Collection|\RoyalPanel\Models\Backup[] $backups
 * @property int|null $backups_count
 * @property \Illuminate\Database\Eloquent\Collection|\RoyalPanel\Models\Database[] $databases
 * @property int|null $databases_count
 * @property Egg|null $egg
 * @property \Illuminate\Database\Eloquent\Collection|\RoyalPanel\Models\Mount[] $mounts
 * @property int|null $mounts_count
 * @property Nest $nest
 * @property Node $node
 * @property \Illuminate\Notifications\DatabaseNotificationCollection|\Illuminate\Notifications\DatabaseNotification[] $notifications
 * @property int|null $notifications_count
 * @property \Illuminate\Database\Eloquent\Collection|\RoyalPanel\Models\Schedule[] $schedules
 * @property int|null $schedules_count
 * @property \Illuminate\Database\Eloquent\Collection|\RoyalPanel\Models\Subuser[] $subusers
...
class Server extends Model implements Identifiable
{
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\RoyalPanel\Models\Subuser, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne<\RoyalPanel\Models\Allocation, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\RoyalPanel\Models\Allocation, $this>
     */
    ...
    public function variables(): HasMany
    {
        return $this->hasMany(EggVariable::class, 'egg_id', 'egg_id')
            ...
            ->leftJoin('server_variables', function (JoinClause $join) {
                ...
                //
                // @see https://github.com/royalpanel/panel/issues/2250
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\RoyalPanel\Models\Node, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\RoyalPanel\Models\Schedule, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\RoyalPanel\Models\Database, $this>
     */
     ...
     *
     * @return \Znck\Eloquent\Relations\BelongsToThrough<\RoyalPanel\Models\Location, \RoyalPanel\Models\Node>
     *
     * @throws \Exception
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne<\RoyalPanel\Models\ServerTransfer, $this>
     */
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\RoyalPanel\Models\Backup, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasManyThrough<\RoyalPanel\Models\Mount, \RoyalPanel\Models\MountServer, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\MorphToMany<\RoyalPanel\Models\ActivityLog, $this>
     */
