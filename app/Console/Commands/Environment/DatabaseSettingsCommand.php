...
class DatabaseSettingsCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->variables['DB_USERNAME'] = $this->option('username') ?? $this->ask(
            'Database Username',
            config('database.connections.mysql.username', 'royalpanel')
        );
        ...
        try {
            ...
            if ($this->confirm('Go back and try again?')) {
                $this->database->disconnect('_royalpanel_command_test');
    ...
    {
        config()->set('database.connections._royalpanel_command_test', [
            'driver' => 'mysql',
        ...
        $this->database->connection('_royalpanel_command_test')->getPdo();
    }
}
