...
namespace RoyalPanel\Console\Commands\Environment;

use Illuminate\Console\Command;
use Illuminate\Contracts\Console\Kernel;
use RoyalPanel\Traits\Commands\EnvironmentWriterTrait;
...
class AppSettingsCommand extends Command
{
     ...
     *
     * @throws \RoyalPanel\Exceptions\RoyalPanelException
     */
    public function handle(): int
    {
        ...
        $this->variables['APP_SERVICE_AUTHOR'] = $this->option('author') ?? $this->ask(
            'Egg Author Email',
            config('royalpanel.service.author', 'unknown@unknown.com')
        );
        ...
        $this->output->comment('Please reference https://royalpanel.io/panel/1.0/additional_configuration.html#telemetry for more detailed information regarding telemetry data and collection.');
        $this->variables['ROYALPANEL_TELEMETRY_ENABLED'] = $this->option('telemetry') ?? $this->confirm(
            'Enable sending anonymous telemetry data?',
            config('royalpanel.telemetry.enabled', true)
        ) ? 'true' : 'false';
