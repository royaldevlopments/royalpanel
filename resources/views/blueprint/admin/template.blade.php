      ...
      <div class="modal-content" style="background-color:transparent">
        <form action="/admin/extensions/blueprint/config" method="POST" autocomplete="off">
          ...
          <div class="modal-body" style="border-color:transparent; border-radius:12px 12px 5px 5px; margin-bottom: 8px">
            ...
            <p class="text-muted text-left">Configure what elements this extension can or can't edit/extend on your RoyalPanel panel.</p><br>
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <p class="text-muted small">Choose on which RoyalPanel eggs this extension should be able to add new pages on.</p>
              </div>
            </div>
          </div>
