          ...
          <form action="/admin/extensions/blueprint" method="POST">
            ...
            <div class="modal-body">
              ...
              <p style="padding-top: 5px;">
                Blueprint is the industry-leading tool to build, manage and maintain extensions for the RoyalPanel panel. You are almost ready to manage extensions, this is the last step.
              </p>
