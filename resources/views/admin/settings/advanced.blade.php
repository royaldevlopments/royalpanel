                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <select class="form-control" name="recaptcha:method">
                                        <option value="recaptcha" @if(old('recaptcha:method', config('recaptcha.method')) == 'recaptcha') selected @endif>Google reCAPTCHA</option>
                                        <option value="turnstile" @if(old('recaptcha:method', config('recaptcha.method')) == 'turnstile') selected @endif>Cloudflare Turnstile</option>
                                    </select>
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label class="control-label">Secret Key</label>
                                <div>
                                    <input type="text" class="form-control" name="turnstile:site_secret" value="{{ old('turnstile:site_secret', config('turnstile.site_secret')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="royalpanel:guzzle:connect_timeout" value="{{ old('royalpanel:guzzle:connect_timeout', config('royalpanel.guzzle.connect_timeout')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="royalpanel:guzzle:timeout" value="{{ old('royalpanel:guzzle:timeout', config('royalpanel.guzzle.timeout')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="control-label">Status</label>
                                <div>
                                    <select class="form-control" name="royalpanel:client_features:allocations:enabled">
                                        <option value="false">Disabled</option>
                                        <option value="true" @if(old('royalpanel:client_features:allocations:enabled', config('royalpanel.client_features.allocations.enabled'))) selected @endif>Enabled</option>
                                    </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="royalpanel:client_features:allocations:range_start" value="{{ old('royalpanel:client_features:allocations:range_start', config('royalpanel.client_features.allocations.range_start')) }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="royalpanel:client_features:allocations:range_end" value="{{ old('royalpanel:client_features:allocations:range_end', config('royalpanel.client_features.allocations.range_end')) }}">
