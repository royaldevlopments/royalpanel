@extends('layouts.royal', ['navbar' => 'colors', 'sideEditor' => true, 'extraWide' => true])
...
@section('content')
    <form action="{{ route('admin.royal.colors') }}" method="POST">
        <div class="header">
            <p>Color settings</p>
        ...
        <div class="color-options">
            ...
            <x-royal.color-input
                target="dangerBorder"
                id="royal:dangerBorder" 
                :value="$dangerBorder"
                helpText="Element border"
            />
            <x-royal.color-input
                target="dangerBackground"
                id="royal:dangerBackground" 
        ...
        <div class="color-options">
            <x-royal.color-input
                ...
                id="royal:secondaryText" 
                :value="$secondaryText"
                helpText="Element text"
            />
            <x-royal.color-input
                target="secondaryBorder"
                id="royal:secondaryBorder" 
                :value="$secondaryBorder"
                helpText="Element border"
            />
            <x-royal.color-input
                target="secondaryBackground"
                id="royal:secondaryBackground" 
