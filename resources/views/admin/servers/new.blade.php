                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="checkbox checkbox-primary no-margin-bottom">
                                    <input id="pStartOnCreation" name="start_on_completion" type="checkbox" {{ \RoyalPanel\Helpers\Utilities::checked('start_on_completion', 1) }} />
                ...
                <div class="panel-card">
                    ...
                    <div class="panel-card-body row">
                        ...
                        <div class="form-group col-xs-12">
                            <div class="checkbox checkbox-primary no-margin-bottom">
                                <input type="checkbox" id="pOomDisabled" name="oom_disabled" value="0" {{ \RoyalPanel\Helpers\Utilities::checked('oom_disabled', 0) }} />
            ...
            <div class="col-md-6">
                <div class="panel-card">
                    ...
                    <div class="panel-card-body row">
                        ...
                        <div class="form-group col-xs-12">
                            <div class="checkbox checkbox-primary no-margin-bottom">
                                <input type="checkbox" id="pSkipScripting" name="skip_scripts" value="1" {{ \RoyalPanel\Helpers\Utilities::checked('skip_scripts', 0) }} />
